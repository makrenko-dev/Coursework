...
namespace Kursovaya_Makrenko_PZ_20_3
{
    public partial class Form24 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult dialogResult = MessageBox.Show("Ви збираєтеся додати запис до таблиці Контрагенти і Адреса , погоджуєтеся? ", "Check", MessageBoxButtons.YesNo, MessageBoxIcon.Information);
                if (dialogResult == DialogResult.Yes)
                {
                    ...
                    var addQuery = $"insert into Kontragent (kod_ka, kod_addr) values('{kod_ka}' , '{kod_addr}')";
                    ...
                    var addQuery1 = $"insert into Journal (diya,chas) values('{"Додано запис у таблицю Контрагенти і Адреса"}' , '{DateTime.Now}')";
