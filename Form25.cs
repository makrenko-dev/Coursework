...
namespace Kursovaya_Makrenko_PZ_20_3
{
    ...
    public partial class Form25 : Form
    {
        ...
        {
            dgv.Rows.Clear();
            string queryString = $"SELECT C.kod_proiz, C.kod_addr, P.name_a, P.city, P.street, P.house, P.office, P.phone FROM Vyrobnyk AS C JOIN Adress AS P ON P.kod_addr = C.kod_addr";
        ...
        private void Update()
        {
            ...
            for (int index = 0; index < dataGridView1.Rows.Count - 1; index++)
            {
                ...
                if (rowState == RowState1.Deleted)
                {
                    ...
                    var deleteQuery = $"delete from Vyrobnyk where kod_prod={id}";
                ...
                if (rowState == RowState1.Modified)
                {
                    ...
                    var kod_proiz = dataGridView1.Rows[index].Cells[0].Value.ToString();
                    ...
                    var changeQuery = $"update Vyrobnyk set kod_addr='{kod_addr}' where kod_proiz='{kod_proiz}'";
        ...
        private void Change()
        {
            ...
            {
                dataGridView1.Rows[selectedRowIndex].SetValues(kod_proiz, kod_addr, name_a, city, street, house, office, phone);
